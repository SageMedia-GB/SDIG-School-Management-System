# Generated by Django 3.1.3 on 2020-11-04 11:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'Headteacher'), (2, 'Teacher'), (3, 'Student'), (4, 'CircuitSupervisor')], default=1, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.grade')),
            ],
            options={
                'db_table': 'Students',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('class_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='core.grade')),
        ...
        migrations.AddField(
            model_name='student',
            name='term_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.termmodel'),
        ),
        migrations.CreateModel(
            name='Headteacher',
            fields=[
        ...
        migrations.AddField(
            ...
            name='class_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.grade'),
        ),
        migrations.AddField(
            model_name='attendance',
            name='term_id',
